...
ALiquidXTestAppCharacter::ALiquidXTestAppCharacter()
{
...
void ALiquidXTestAppCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ALiquidXTestAppCharacter::Look);

	}

}

void ALiquidXTestAppCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ALiquidXTestAppCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
